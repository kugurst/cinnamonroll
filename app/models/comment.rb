class Comment
  ...
  embeds_many :comments, as: :com_thread, cyclic: true, cascade_callbacks: true, after_add: :increment_total_and_chain, after_remove: :decrement_total_and_chain
  embedded_in :com_thread, cyclic: true
  # accepts_nested_attributes_for :child_comments, polymorphic: true

  validates :body, :user_id, :post_id, :nesting_level, :total_comments, presence: true
